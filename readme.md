...
I am looking to start my "Adventure of a lifetime" with a headlining company with the same level of passion for their business as mud covered festival gathers watching Coldplay in a Somerset field. Finding a place with a company that shares the same drive for well crafted software that I do along with Agile practices would be (to quote another number one hit!) my idea of paradise.
